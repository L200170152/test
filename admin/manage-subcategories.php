...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblkategori.KategoriNama as catname, subkategori.subCategory as subcatname, subkategori.subCategoriDesc as SubCatDescription, subkategori.PostingDate as subcatpostingdate,
subkategori.UpdationPost as subcatupdationdate, subkategori.SubCategoryId as subcatid from subkategori join tblkategori on tblkategori.categoryId=tblkategori.id where subkategori.Is_Active=1");
$cnt=1;

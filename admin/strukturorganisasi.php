...
if(isset($_POST['tombol']))
{
    ...
    else
    {
        if ($file_size < 2048000 and (($file_type =='image/jpeg') or ($file_type == 'image/png') or ($file_type == 'image/jpg')))
        {
            ...
            mysqli_query($con,"insert into strukturorganisasi (nama,ukuran,tipe,keterangan) values ('$file_name','$file_size','$file_type','$keterangan')");
            header("location:viewstrukturorganisasi.php");
        }
        else
        {
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Tambah Struktur Organisasi</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Tambah Struktur Organisasi </b></h4>
                                    <hr />

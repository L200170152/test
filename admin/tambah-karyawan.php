...
$query=mysqli_query($con,"insert into tblkaryawan(namakaryawan,jabatan) values('$nama','$jabatan')");
if($query)
{
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Tambah Karyawan </b></h4>
                                    <hr />
                        				...
                        				<div class="col-md-6">
                        					<form class="form-horizontal" name="nip" method="post">
                                                ...
                                                <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                    <input type="text" class="form-control" value="" name="namakaryawan" required>
	                                                </div>
	                                            </div>

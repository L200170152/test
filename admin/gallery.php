...
if(isset($_POST['tombol']))
{
    ...
    else
    {
        if ($file_size < 2048000 and (($file_type =='image/jpeg') or ($file_type == 'image/png') or ($file_type == 'image/jpg')))
        {
            ...
            mysqli_query($con,"insert into gallery (nama,ukuran,tipe,keterangan) values ('$file_name','$file_size','$file_type','$keterangan')");
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Tambah Gallery </b></h4>
                                    <hr />

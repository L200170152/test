                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Data Tamu Website</h4>
											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select tblbukutamu.id,  tblbukutamu.name, tblbukutamu.email, tblbukutamu.postingDate, tblbukutamu.comment, 
 from  tblbukutamu where tblbukutamu.status=0");
$cnt=1;
